...
async def get_user_by_login(
    ...
    query = select(Organization).where(Organization.manager_id == current_id)
    ...
    if users == None:
        raise HTTPException(
            ...
            detail={
                "status": "error",
                "data": None,
                "details": "There are no users in the organization",
            },
        )
    users = [
    ...
    if current_user.organization_id == None:
        raise HTTPException(
            ...
            detail={
                "status": "error",
                "data": None,
                "details": "Please create an organization first",
            },
        )
    ...
    if current_user.organization_id != user.organization_id:
        raise HTTPException(
            ...
            detail={
                "status": "error",
                "data": None,
                "details": f"User {id} is not a member of your organization",
            },
        )
    ...
    if user_role in ["Администратор", "Менеджер"]:
        raise HTTPException(
            ...
            detail={
                "status": "error",
                "data": None,
                "details": "You cannot delete an administrator or manager roles",
            },
        )
